...
const App = () => {
    ...
    // Auto-update to next day at midnight
    useEffect(() => {
        ...
        const midnightCheck = setInterval(() => {
            ...
            if (currentDate !== lastDate) {
                ...
                if (viewDate === lastDate) {
                    // User was viewing "today", so switch to the new day
    ...
    const getWeekTotal = () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            if (history[dateStr]) {
                total += history[dateStr].filter(Boolean).length;
            }
        }
        return total;
    };
                ...
                <div className="glass side-panel analytics-anim">
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                        ...
                        <button 
                            ...
                            onClick={() => setViewDate(getLocalDateString())}
                        >
                            Today
                        </button>
                    </div>
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <span style={{ fontSize: '0.8rem', background: 'rgba(139, 92, 246, 0.2)', padding: '0.3rem 0.6rem', borderRadius: '4px', color: 'var(--accent)' }}>
                                Last 7 Days: {getWeekTotal()} hrs
                            </span>
                        </div>
                    ...
                    <div style={{ marginTop: '2rem', borderTop: '1px solid var(--glass-border)', paddingTop: '1.5rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem' }}>
                            <button className="btn" style={{ flex: 1, fontSize: '0.8rem' }} onClick={() => {
                                ...
                                a.href = url;
                                a.download = `study-tracker-backup-${getLocalDateString()}.json`;
                                a.click();
                            }}>Backup JSON</button>
